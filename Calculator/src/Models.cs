...
internal sealed class Recipe
{
    ...
    [JsonPropertyName("RecipeTier")]
    public int Tier
    {
        get; init;
    }
    /// <summary>游戏资源中的高阶卡面标记，0为普通卡面。</summary>
    [JsonPropertyName("IsSR")]
    public int SrFlag
    {
        get; init;
    }
...
internal sealed class TraitEffect
{
    ...
    [JsonPropertyName("TraitEffect")]
    public int Kind
    {
        get; init;
    }
    /// <summary>原生阶段/范围条件。</summary>
    [JsonPropertyName("TraitActivationCondition")]
    public int Condition
    {
        get; init;
    }
    /// <summary>原生参数，百分比效果按各自规则换算。</summary>
    [JsonPropertyName("Parameter0")]
    public double Value
    {
        get; init;
    }
...
internal sealed class CardTemplate
{
    ...
    public double InnerStructure
    {
        get; init;
    }
    /// <summary>范围外其他卡阶段的槽位收益粗略结构分。</summary>
    public double OuterStructure
    {
        get; init;
    }
